      ...
      <form className={classes.root} autoComplete="off">
        ...
        >
          ...
          <div className="fs-2 mb-5">
            Select the Normal range of Heart Rate for humans.{" "}
              ...
              >
                <div className="d-flex justify-content-around">
                  <FormControlLabel
                    ...
                    value="female"
                    control={<BpRadio />}
                    label={<Typography className="fs-4">40-60</Typography>}
                  />
                  <FormControlLabel
                    className="p-4"
                    value="male"
                    control={<BpRadio />}
                    label={<Typography className="fs-4">60-90 </Typography>}
                  />
                </div>
                <div className="d-flex justify-content-around">
                  <FormControlLabel
                    ...
                    value="other"
                    control={<BpRadio />}
                    label={<Typography className="fs-4"> 70-120</Typography>}
                  />
                  <FormControlLabel
                    className="p-4"
                    value="disabled"
                    // disabled
                    control={<BpRadio />}
                    label={<Typography className="fs-4">90-150</Typography>}
                  />
                </div>
              </RadioGroup>
              {/* <div className="d-flex justify-content-around">
