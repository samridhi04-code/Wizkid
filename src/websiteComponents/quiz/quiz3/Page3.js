    ...
    <>
      <form className={classes.root} autoComplete="off">
        ...
        >
          ...
          Look at the image below and select the right location on the wrist to check for the Pulse - for the radial artery. 
              ...
              >
                <div className="d-flex justify-content-around">
                  {/* <FormControlLabel
                    ...
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">Inner side of wrist 
                ...
                <div className="d-flex justify-content-around">
                  {/* <FormControlLabel
                    ...
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">   Outer side of wrist</Typography>
                    }
                  />
                  <FormControlLabel
                    className="p-4"
                    ...
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">None of the above</Typography>
                    }
                  /> */}
                    <div className="mx-4 mt-5 bg-primary p-3 rounded-3 fs-5">
                  <p style={{width:'13rem'}}>
                  Outer side of wrist </p>
                </div>
                <div className="mx-4 mt-5 bg-primary p-3 rounded-3 fs-5">
                  <p style={{width:'13rem'}}>
                  None of the above</p>
