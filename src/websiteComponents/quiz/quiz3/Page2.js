              ...
              > */}
                <div className="d-flex justify-content-around">
                  {/* <FormControlLabel
                    ...
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">Blood pressure</Typography>
                    }
                  />
                  <FormControlLabel
                    className="p-4"
                ...
                <div className="d-flex justify-content-around">
                  {/* <FormControlLabel
                    ...
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">Heart Rate </Typography>
                    }
                  />
                  <FormControlLabel
                    className="p-4"
                    ...
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">Temperature</Typography>
                    }
                  />  */}
                   <div className="mx-4 mt-5 bg-primary p-3 rounded-3 fs-5">
                Heart Rate  <p style={{width:'10rem'}}>
                 </p>
                </div>
                <div className="mx-4 mt-5 bg-primary p-3 rounded-3 fs-5">
                  <p style={{width:'10rem'}}>
