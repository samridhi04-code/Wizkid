      ...
      <form className={classes.root} autoComplete="off">
        ...
        >
          ...
          <div className="fs-2 mb-5">
            Which part of the brain controls the body temperature in humans?{" "}
              ...
              >
                <div className="d-flex justify-content-around">
                  <FormControlLabel
                    ...
                    value="female"
                    control={<BpRadio />}
                    label={<Typography className="fs-4">Medulla </Typography>}
                  />
                  <FormControlLabel
                    className="p-4"
                    value="male"
                    control={<BpRadio />}
                    label={<Typography className="fs-4">Thalamus </Typography>}
                  />
                </div>
                <div className="d-flex justify-content-around">
                  <FormControlLabel
                    ...
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">Hypothalamus </Typography>
                    }
                  />
                  <FormControlLabel
                    className="p-4"
                    ...
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">Corpus Callosum </Typography>
                    }
                  />
                </div>
              </RadioGroup>
