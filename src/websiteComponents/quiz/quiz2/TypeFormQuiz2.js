...
import { Confirmation } from "../quiz2/Confirmation";
...
export const TypeFormQuiz2 = ({ children, onSubmit }) => {
        ...
        <form className={classes.box} onSubmit={onSubmit}>
          ...
          >
            ...
            {fields < children.length - 2 && (
              <Button
                className="rounded-pill px-4 py-2 bg-light text-dark"
                onClick={nextField}
              >
                Next
              </Button>
            ...
            {fields === children.length - 2 && (
              <Button className="rounded-pill px-4 py-2 bg-light text-dark" onClick={nextField}>Submit</Button>
            )}
          </ButtonGroup>
        </form>
      </React.Fragment>
