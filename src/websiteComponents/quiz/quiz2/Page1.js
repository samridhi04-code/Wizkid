...
import "../quiz2/LessonTwoQuiz.css";
      ...
      <form className={classes.root} autoComplete="off">
        ...
        >
          ...
          <div className="fs-2 mb-5">
            In India, how many doctors are there for every 1000 people?{" "}
              ...
              > */}
                <div className="d-flex justify-content-around">
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Typography className="fs-4">
                        5-100 doctors / 1000 people{" "}
                      </Typography>
                    }
                  /> */}
                    <div className="mx-4 mt-5 bg-primary p-3 rounded-3">
                  <p style={{width:'14rem'}}> >100 doctors / 1000 people</p>
                </div>
                <div className="ms-4 mt-5 bg-primary p-3 rounded-3">
                  <p style={{width:'14rem'}}>  5-100 doctors / 1000 people</p>
                </div>
                </div>
                <div className="d-flex justify-content-around">
                  {/* <FormControlLabel
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Typography className="fs-4">
                        1-10 Doctor / 1000 people
                      </Typography>
                    }
                  /> */}
                  <div className="mx-4 mt-5 bg-primary p-3 rounded-3">
                  <p style={{width:'14rem'}}>10-50 doctors / 1000 people</p>
                </div>
                <div className="ms-4 mt-5 bg-primary p-3 rounded-3">
                  <p style={{width:'14rem'}}>1-10 Doctor / 1000 people</p>
                </div>
                </div>
              {/* </RadioGroup> */}
              {/* <div className="d-flex justify-content-around">
