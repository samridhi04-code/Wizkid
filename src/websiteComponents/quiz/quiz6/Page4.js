      ...
      <form className={classes.root} autoComplete="off">
        ...
        >
          ...
          <div className="fs-2 mb-5">
            Which is the important test for diagnosing a heart attack{" "}
              ...
              >
                <div className="d-flex justify-content-around">
                  <FormControlLabel
                    ...
                    value="female"
                    control={<BpRadio />}
                    label={<Typography className="fs-4">EMG</Typography>}
                  />
                  <FormControlLabel
                    className="p-4"
                    value="male"
                    control={<BpRadio />}
                    label={<Typography className="fs-4"> EEG </Typography>}
                  />
                </div>
                <div className="d-flex justify-content-around">
                  <FormControlLabel
                    ...
                    value="other"
                    control={<BpRadio />}
                    label={<Typography className="fs-4"> ECG</Typography>}
                  />
                  <FormControlLabel
                    className="p-4"
                    value="disabled"
                    // disabled
                    control={<BpRadio />}
                    label={<Typography className="fs-4"> MRI</Typography>}
                  />
                </div>
              </RadioGroup>
              {/* <div className="d-flex justify-content-around">
