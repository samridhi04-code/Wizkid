      ...
      <form className={classes.root} autoComplete="off">
        ...
        >
          ...
          <div className="fs-2 mb-5">
            In which organ does the blood get oxygenated?{" "}
              ...
              > */}
                <div className="d-flex justify-content-around">
                  {/* <FormControlLabel
                    ...
                    value="female"
                    control={<BpRadio />}
                    label={<Typography className="fs-4">Heart</Typography>}
                  />
                  <FormControlLabel
                    className="p-4"
                    value="male"
                    control={<BpRadio />}
                    label={<Typography className="fs-4"> </Typography>}
                  /> */}
                ...
                <div className="d-flex justify-content-around">
                  {/* <FormControlLabel
                    ...
                    value="other"
                    control={<BpRadio />}
                    label={<Typography className="fs-4">Lung</Typography>}
                  />
                  <FormControlLabel
                    className="p-4"
                    value="disabled"
                    // disabled
                    control={<BpRadio />}
                    label={<Typography className="fs-4">Kidney</Typography>}
                  /> */}
                      <div className="mx-4 mt-5 bg-primary p-3 rounded-3 fs-5">
                  <p style={{width:'15rem'}}>
                  Lung </p>
