      ...
      <form className={classes.root} autoComplete="off">
        ...
        >
          ...
          <div className="fs-2 mb-5">
            What is the sac covering the heart called ?{" "}
              ...
              >
                <div className="d-flex justify-content-around">
                  <FormControlLabel
                    ...
                    value="female"
                    control={<BpRadio />}
                    label={<Typography className="fs-4">Epicardium</Typography>}
                  />
                  <FormControlLabel
                    className="p-4"
                    value="male"
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">Myocardium </Typography>
                    }
                  />
                </div>
                <div className="d-flex justify-content-around">
                  <FormControlLabel
                    ...
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">Endocardium</Typography>
                    }
                  />
                  <FormControlLabel
                    className="p-4"
                    ...
                    control={<BpRadio />}
                    label={
                      <Typography className="fs-4">Pericardium</Typography>
                    }
                  />
                </div>
              </RadioGroup>
